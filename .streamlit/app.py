...
# --- CONFIGURAÇÃO E ESTILO DIAMOND (RIHANNA STYLE ORIGINAL) ---
st.set_page_config(page_title="DIAMOND TAX | O Garimpeiro", layout="wide", page_icon="⛏️")

def aplicar_estilo_diamond_original():
    st.markdown("""
        <style>
        ...
        /* 5. SIDEBAR E INPUT DE CNPJ DESTACADO (ESTILO DIAMOND TAX) */
...
aplicar_estilo_diamond_original()
...
with st.sidebar:
    ...
    # AJUSTE FINO: Campo sempre visível, com borda rosa e instruções
    cnpj_input = st.text_input(
        "CNPJ DO CLIENTE", 
        placeholder="00.000.000/0001-00",
        help="Digite o CNPJ da empresa. Pode conter pontos e barras ou apenas números."
    )
...
if st.session_state['confirmado']:
    if not st.session_state['garimpo_ok']:
        st.markdown(f"🏢 **Garimpo Ativo para:** {cnpj_limpo}")
        ...
        st.markdown("### 📊 Resumo e Sequência")
