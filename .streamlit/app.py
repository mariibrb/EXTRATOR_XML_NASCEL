...
# --- CONFIGURAÇÃO E ESTILO (CLONE EXATO DO DIAMOND TAX) ---
...
with st.sidebar:
    ...
    # CAMPO IDÊNTICO AO DIAMOND TAX (Placeholders e Help)
    ...
    if cnpj_input and len(cnpj_limpo) != 14:
        st.error("⚠️ O CNPJ deve ter 14 números.") # Letra Preta do st.error (Igual ao Tax)
...
if st.session_state['confirmado']:
    st.info(f"🏢 Operação liberada para o CNPJ: {cnpj_limpo}") # Letra Preta do st.info (Igual ao Tax)
